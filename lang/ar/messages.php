...
return [
    ...
    'driver_service_request_title' => 'طلب خدمة من السائق',
    'driver_service_request_message' => 'السائق :name قدم طلب خدمة جديد.',
    'new_order_title' => 'طلب جديد',
    'new_order_message' => 'طلب جديد من الشركة: :company',
    'new_order_message_fallback' => 'طلب جديد من عميل',
    'order_task_started_title' => 'بدء تنفيذ الطلب',
    'order_task_started_message' => ':technician :status — الطلب #:id',
    'order_assigned_to_technician' => 'معيّن لفني',
    'order_in_progress' => 'قيد التنفيذ',
    'order_assigned_title' => 'تم إسناد طلب جديد لك',
    'order_cancel_requested_title' => 'طلب إلغاء طلب',
    'order_cancel_requested_message' => 'هناك طلب إلغاء للطلب رقم #:id',
    'order_started_title' => 'تم بدء تنفيذ طلبك',
    'order_started_message' => 'الفني :name بدأ بتنفيذ طلبك',
    'technician_accepted_title' => 'تم قبول اسناد الطلب',
    'technician_rejected_title' => 'تم رفض اسناد الطلب',
    'technician_accepted_message' => 'الفني :name قبل تنفيذ الطلب',
    'technician_rejected_message' => 'الفني :name رفض تنفيذ الطلب',
    'payment_paid_message' => 'شركة :company دفعت :amount ر.س (:method) للطلب #:id',
    'payment_received_title' => 'تم استلام دفعة',
    'payment_method_cash' => 'كاش',
    'payment_method_tap' => 'Tap',
    'payment_method_bank' => 'تحويل بنكي',
    'driver_unknown' => 'غير معروف',
    'technician' => 'الفني',

    // Auth (Unified)
    'phone_not_company' => 'رقم الجوال غير مسجّل كشركة. تواصل مع المسؤول لإنشاء حساب.',
    'phone_not_driver' => 'رقم الجوال غير مسجّل كسائق لمركبة. تواصل مع شركتك لإضافة جوالك.',
    'phone_not_found' => 'رقم الجوال غير مسجّل كشركة أو كسائق. تواصل مع المسؤول لإنشاء حساب.',
    ...
    // Maintenance RFQ
    'maintenance_center_not_found' => 'لم يتم العثور على مركز صيانة بهذا الرقم.',
    'login_success' => 'تم تسجيل الدخول بنجاح.',
    'request_rejected' => 'تم رفض الطلب.',
    'rfq_sent' => 'تم إرسال طلب العروض للمراكز المحددة.',
    'center_approved' => 'تم اعتماد المركز.',
    'quotes_rejected_re_requested' => 'تم رفض العروض. تم إرسال طلب عروض جديد.',
    'invoice_approved' => 'تمت الموافقة على الفاتورة. الطلب مغلق.',
    'invoice_rejected' => 'تم رفض الفاتورة.',
    'quotation_submitted' => 'تم تقديم العرض بنجاح.',
    'job_started' => 'تم وضع العمل قيد التنفيذ.',
    'invoice_uploaded' => 'تم رفع الفاتورة النهائية. بانتظار الموافقة.',
    'maintenance_center_added' => 'تم إضافة مركز الصيانة إلى قائمتك.',
    'maintenance_center_removed' => 'تم إزالة مركز الصيانة.',
];
