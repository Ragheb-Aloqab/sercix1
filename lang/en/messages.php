...
return [
    ...
    'driver_service_request_title' => 'Service request from driver',
    'driver_service_request_message' => 'Driver :name submitted a new service request.',
    'new_order_title' => 'New order',
    'new_order_message' => 'New order from company: :company',
    'new_order_message_fallback' => 'New order from customer',
    'order_task_started_title' => 'Order execution started',
    'order_task_started_message' => ':technician :status — Order #:id',
    'order_assigned_to_technician' => 'Assigned to technician',
    'order_in_progress' => 'In progress',
    'order_assigned_title' => 'New order assigned to you',
    'order_cancel_requested_title' => 'Order cancellation requested',
    'order_cancel_requested_message' => 'There is a cancellation request for order #:id',
    'order_started_title' => 'Your order has started',
    'order_started_message' => 'Technician :name has started your order',
    'technician_accepted_title' => 'Order assignment accepted',
    'technician_rejected_title' => 'Order assignment rejected',
    'technician_accepted_message' => 'Technician :name accepted the order assignment',
    'technician_rejected_message' => 'Technician :name rejected the order assignment',
    'payment_paid_message' => 'Company :company paid :amount SAR (:method) for order #:id',
    ...
    // Maintenance RFQ
    'maintenance_center_not_found' => 'Maintenance center not found with this phone number.',
    'login_success' => 'Logged in successfully.',
    'request_rejected' => 'Request rejected.',
    'rfq_sent' => 'RFQ sent to selected centers.',
    'center_approved' => 'Center approved.',
    'quotes_rejected_re_requested' => 'Quotes rejected. New RFQ sent.',
    'invoice_approved' => 'Invoice approved. Request closed.',
    'invoice_rejected' => 'Invoice rejected.',
    'quotation_submitted' => 'Quotation submitted successfully.',
    'job_started' => 'Job marked as started.',
    'invoice_uploaded' => 'Final invoice uploaded. Waiting for approval.',
    'maintenance_center_added' => 'Maintenance center added to your list.',
    'maintenance_center_removed' => 'Maintenance center removed.',
];
