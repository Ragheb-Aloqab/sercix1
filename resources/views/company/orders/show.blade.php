        ...
        <div class="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 shadow-soft p-5">
            <div class="flex items-start justify-between gap-4">
                ...
                <div>
                    ...
                    <form action="{{ route('company.orders.cancel', $order->id) }}" method="POST">
                        @csrf
                        <button type="submit"
                                class="my-4 @if($order->status==='completed') hidden @endif  px-4 py-2 rounded-xl border border-rose-300 bg-rose-50 text-rose-700
               dark:border-rose-800 dark:bg-rose-900/30 dark:text-rose-400 font-semibold">
                            إلغاء الطلب
                        </button>
                    </form>
                </div>
