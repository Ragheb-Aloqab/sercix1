    ...
    <div class="space-y-6">
        ...
        <form method="GET" class="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 shadow-soft p-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3 items-end">
                <div>
                    <label class="block text-xs font-bold text-slate-500 dark:text-slate-400 mb-1">{{ __('invoice.filter_from_date') }}</label>
                ...
                <div>
                    <label class="block text-xs font-bold text-slate-500 dark:text-slate-400 mb-1">{{ __('invoice.filter_to_date') }}</label>
                ...
                <div>
                    <button type="submit" class="w-full px-4 py-3 min-h-[44px] rounded-xl bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-semibold">
                                ...
                                <td class="p-3 sm:p-4">
                                    <div class="flex flex-wrap gap-2">
                                        <a href="{{ route('company.invoices.show', $invoice) }}"
                                            class="inline-flex items-center justify-center gap-1 px-3 py-2 min-h-[44px] rounded-xl border border-slate-200 dark:border-slate-800 font-semibold hover:bg-slate-50 dark:hover:bg-slate-800 active:scale-[0.98]">
